...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    // URLs ,configurations and Your Specific Channel JID
    const channelJid = "120363425127251695@newsletter"; 
    const fullImageUrl = "https://files.catbox.moe/9nlsf2.jpg"; // Full image URL
    const smallThumbnailUrl = "https://files.catbox.moe/9nlsf2.jpg"; // Small thumbnail URL
    const randomAudio = "https://files.catbox.moe/7pi2bu.mp3"; // Voice note URL
    const sourceUrl = "https://whatsapp.com/channel/0029Vb7HhcI2ZjCj6clT5D1x"; // Channel link
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        caption: `ʙᴜsᴛᴀʀᴢᴏɴᴇ ᴍᴅ ALWAYS ALIVE ✌️😎\n\n✨ Contact: ${contactName}\n🧎 [Visit Channel](${sourceUrl})`,
...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    const fullImageUrl = "https://files.catbox.moe/j0uys7.mp3"; // Full image URL
    const smallThumbnailUrl = "https://files.catbox.moe/aktbgo.jpg"; // Small thumbnail URL
    const randomAudio = "https://files.catbox.moe/7pi2bu.mp3"; // Voice note URL
    const sourceUrl = "https://whatsapp.com/channel/0029VatokI45EjxufALmY32X"; // Channel link
    const contactName = commandeOptions?.ms?.pushName || "Unknown Contact"; // Sender's name or "Unknown Contact"
