...
zokou({
  ...
  // Check if the command is issued by the owner
    if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr SILA MD σwnєr");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
    if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr SILA MD σwnє");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or bustarzone md owner.* ,,idiot");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or ʙᴜsᴛᴀʀᴢᴏɴᴇ ᴍᴅ owner.* ,,idiot");
  }
