...
zokou({
  ...
  const contacts = [
    ...
    '255760164530@s.whatsapp.net',
    '255770208711@s.whatsapp.net'
  ];

  await repondre("*BUSTARZONE MD-BOT is sending your message to Developer contacts 🤦🤷*...");
...
𝗦𝗲𝗻𝗱𝗲𝗿 𝗡𝗮𝗺𝗲 : ${nomAuteurMessage}`;
  ...
  for (let contact of contacts) {
    await zk.sendMessage(contact, {
      image: { url: 'https://files.catbox.moe/9nlsf2.jpg' },
